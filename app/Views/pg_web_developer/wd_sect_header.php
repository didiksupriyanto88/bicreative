<div class="sect-wd-header-bg">
    <div class="wd-container-1 grid-container grid-50">
        ...
        <div class="wd-hdr-grid-item-2">
            <h1>Web Development</h1>
            <h2>Wujudkan website profesional untuk berbagai kebutuhan dengan desain tampilan, fitur dan teknologi website yang paling up-to-date</h2>
        </div>
    </div>
</div>